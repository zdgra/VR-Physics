    ...
    public class SlideConstraint : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (initialPosition != null && finalPosition != null)
            {
                ...
                if ((initialDistance + finalDistance) > sliderDistance && initialDistance < finalDistance)
                {
                ...
                else if ((initialDistance + finalDistance) > sliderDistance && initialDistance > finalDistance)
                {
